...
class FarmDetailFragment : Fragment(), OnMapReadyCallback {
    ...
    override fun onMapReady(gmap: GoogleMap?) {
        ...
        val m1 = farmLocation
        val m2 = LatLng(-m1.latitude, m1.longitude)
        val m3 = LatLng(-m1.latitude, -m1.longitude )
        val m4 = LatLng(m1.latitude, -m1.longitude)
        ...
        mMap.addMarker(MarkerOptions().position(farmLocation).title("${farm?.farmName} "))
